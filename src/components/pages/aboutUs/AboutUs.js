...
class AboutUs extends Component {
  ...
  isMemberExist = (memberName) => {
    return this.state.team.defaultTeam.some(
      (member) => member.nickname === memberName
    );
  };

  getMemberInformation = (memberName) => {
    return this.state.team.defaultTeam.find(
      (member) => member.nickname === memberName
    );
  };
  ...
  componentDidMount() {
    if (
      ...
      this.props.fetchRimBuildingImages().then(() => {
        this.setState({
          listBuildingImagesCarousel: this.props.rimBuildingImages,
        });
      });
        ...
        <div className="hero__wrap hero2cols">
          ...
          >
            <Container>
              <Row>
                <Col>
                  <h1 className="h1">Мисия</h1>
                </Col>
              </Row>
              <Row className="justify-content-between">
                <Col lg={4}>
                  <p className="about-us-page__text__bold">
                    Създаден през 1935 г. от{" "}
                    <a
                      href="/#"
                      className="color-red cursor-pointer link"
                      onClick={(e) => {
                        this.handleShowModal(
                          "modal-shishkov",
                          "",
                    ...
                    – родоповед, учител, издател, музеен деец и общественик с
                    европейски измерения, Историческият музей в Смолян е
                    най-големият музей, съхраняващ знаците на паметта на
                    населението, обитавало централната част на Родопската област
                    през различните исторически епохи.
                  </p>
                </Col>
                <Col lg={6}>
                  <p className="paragraph-2">
                    Регионален исторически музей “Стою Шишков” днес носи с
                    достойнство името на своя основател и провежда политиката по
                    издирване, изучаване, опазване и популяризиране на движимите
                    паметници на историята, бита и културата на Среднородопския
                    край.
                  </p>
                  <p className="paragraph-2">
                    Чрез своите уникални колекции, показващи цялото културно
                    многообразие и хилядолетните традиции, чрез
                    изследователските и популяризаторските си ресурси,
                    изграждайки мрежа от успешни партньорства, музеят работи в
                    полза на обществото – за неговото духовно обогатяване и
                    вдъхновение чрез завръщане към корените и опознаване на
                    различни култури.
                  </p>
                </Col>
              </Row>
        ...
        <main>
          ...
          <InfoColumn
            ...
            showRulesForActivity={
              this.state.infoColumn.history.showRulesForActivity
            }
          ...
          <section className="section-building">
            <Container>
                      ...
                      <h1
                        ...
                        dangerouslySetInnerHTML={{
                          __html: intl.formatMessage({
                            id: this.state.infoColumn.building.title,
                          }),
                        }}
                      ></h1>
                    </div>
              ...
              <CardInfoLine
                ...
                link={"/about-us/regular-programs"}
              />
            </Container>
          </section>
          <section className="section-team">
            <div className="section-team__container-wrap">
              <Container>
                ...
                <div className="section-team__headmaster-wrap">
                  {this.props.team.headmaster &&
                  this.props.team.headmaster.length !== 0 ? (
            ...
            <div className="section-team__container-wrap">
              <Container>
                ...
                <div className="section-team__headmaster-wrap">
                  <Row>
                    {this.props.team.archeology &&
                    this.props.team.archeology.length !== 0 ? (
            ...
            <div className="section-team__container-wrap">
              <Container>
                ...
                <div className="section-team__headmaster-wrap">
                  <Row>
                    {this.props.team.fundsAndScientificArchives &&
                    this.props.team.fundsAndScientificArchives.length !== 0 ? (
            ...
            {this.props.team.ethnography &&
            this.props.team.ethnography.length !== 0 ? (
              <div className="section-team__container-wrap">
                <Container>
                  <div className="section-team__title__wrap">
                    <h2 className="h2">
            ...
            <div className="section-team__container-wrap">
              <Container>
                ...
                <div className="section-team__headmaster-wrap">
                  <Row>
                    {this.props.team.publicRelations &&
                    this.props.team.publicRelations.length !== 0 ? (
            ...
            <div className="section-team__container-wrap">
              <Container>
                ...
                <div className="section-team__headmaster-wrap">
                  <Row>
                    {this.props.team.administration &&
                    this.props.team.administration.length !== 0 ? (
