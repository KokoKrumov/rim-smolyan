                        ...
                        <div>
                            <figure className='modal__barelef modal__barelef-figure'>
                                <div className="img__wrap">
                                    <img className="img-fluid" src={StShishkovBarelef} alt="StShishkovBarelef"
                                         itemProp="image"/>
                                </div>
                                <figcaption className='modal__barelef__text'>
                                    <p className="paragraph-sm"
                                       dangerouslySetInnerHTML={{__html: intl.formatMessage({id: 'about-us.shishkov.modal.figcaption'})}}>
                                    </p>
                                </figcaption>
                            </figure>
                        </div>
...
export default withIntl(connect(mapStateToProps, mapDispatchToProps)(ModalShishkovContent));
