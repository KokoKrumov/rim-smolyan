            ...
            <div className='news-detail-page__wrap'>
                    ...
                    <div className='breadcrumb__wrap'>
                        {
                            ...
                            <ol className='breadcrumb'>
                                <li className='breadcrumb-item'>
                                    <a className="link" href={`/${data.articleSection}`}
                                       itemProp="url" target=""
                                       rel="noopener nofollow noreferrer"
                                       dangerouslySetInnerHTML={{__html: intl.formatMessage({id: `menu.${data.articleSection}`})}}/>
                ...
                {/*ADDITIONAL CONTENT*/}
                {
                    ...
                    <Container>
                        ...
                        <Row>
                            <NewsAndEventsList listOfNewsAndEvents={data.listOfNewsAndEvents}/>
                        </Row>
                    </Container>
                }
