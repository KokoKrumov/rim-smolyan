...
import xDarkLogo from "../../assets/images/twitter-dark.svg";

function SocialButton({ buttonType, articleTitle, url, hashtag = null, link = null, light = false }) {
  ...
  const twitterShareButton = () => {
    return (
      <XShareButton
        ...
        title={articleTitle}
      >
        <img src={xDarkLogo} width="17" height="16" alt="" />
      </XShareButton>
    );
  };
  ...
  const twitterLinkButton = () => {
    return (
      <a
        ...
        rel="noopener noreferrer"
      >
        <img src={light ? xDarkLogo : xLogo} width="17" height="16" alt="" />
      </a>
    );
  };
  ...
  const instagramLinkButton = () => {
    return (
      <a
        href="https://www.instagram.com/museumsmolyan/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <svg
  ...
  const youtubeLinkButton = () => {
    return (
      <a
        href="https://www.youtube.com/channel/UC-s9opkUpjdAn6OGNIcPIBQ"
        target="_blank"
        rel="noopener noreferrer"
      >
        <svg
          height="18px"
          viewBox="20 -70 612 512"
          width="25px"
          xmlns="http://www.w3.org/2000/svg"
        >
