...
import ModalRedirectContent from "../modal/ModalRedirectContent";
...
function SocialButton({buttonType, articleID, articleTitle, url}) {
    ...
    const youtubeLinkButton = () => {
        return (
            <a href="https://www.youtube.com/channel/UC-s9opkUpjdAn6OGNIcPIBQ" target="_blank"
               rel="noopener noreferrer">
                <svg height="18px" viewBox="20 -70 612 512" width="25px" xmlns="http://www.w3.org/2000/svg"><path d="m626.8125 64.035156c-7.375-27.417968-28.992188-49.03125-56.40625-56.414062-50.082031-13.703125-250.414062-13.703125-250.414062-13.703125s-200.324219 0-250.40625 13.183593c-26.886719 7.375-49.03125 29.519532-56.40625 56.933594-13.179688 50.078125-13.179688 153.933594-13.179688 153.933594s0 104.378906 13.179688 153.933594c7.382812 27.414062 28.992187 49.027344 56.410156 56.410156 50.605468 13.707031 250.410156 13.707031 250.410156 13.707031s200.324219 0 250.40625-13.183593c27.417969-7.378907 49.03125-28.992188 56.414062-56.40625 13.175782-50.082032 13.175782-153.933594 13.175782-153.933594s.527344-104.382813-13.183594-154.460938zm-370.601562 249.878906v-191.890624l166.585937 95.945312zm0 0"/></svg>
            </a>
        )
    }

    switch (buttonType) {
        case 'facebook-share__news':
            return facebookShareNewsButton()
        case 'facebook-share__share-page':
            return facebookShareURLButton()
        case 'facebook-link':
            return facebookLinkButton()
        case 'twitter-share__news':
            return twitterShareNewsButton()
        case 'twitter-share__share-page':
            return twitterShareURLButton()
        case 'twitter-link':
            return twitterLinkButton()
        case 'instagram-link':
            return instagramLinkButton()
        case 'youtube-link':
            return youtubeLinkButton()
    }
