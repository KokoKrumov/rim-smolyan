                           ...
                           <Col lg={6}>
                               <div className='carousel-megatron__controls'>
                                   ...
                                   <div  className='carousel-megatron__controls__wrap'>
                                       <button className='btn carousel-megatron__controls-btn' onClick={() => carousel.slidePrev()}>
                                           <img className="carousel-megatron__controls-btn__img" src={carouselMegatronArrowLeft} alt=""
                                                itemProp="image"/>
                                       </button>
                                       <button className='btn carousel-megatron__controls-btn' onClick={() => carousel.slideNext()}>
                                           <img className="carousel-megatron__controls-btn__img" src={carouselMegatronArrowRight} alt=""
                                                itemProp="image"/>
                                       </button>
                                   </div>
                               </div>
