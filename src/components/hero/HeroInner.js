            ...
            <Container>
                            ...
                            <div className='breadcrumb__wrap'>
                                <ol className='breadcrumb'>
                                    <li className='breadcrumb-item'>
                                        <a className="link" href={`/${props.breadcrumbs.parentLink}`}
                                           itemProp="url" target=""
                                           rel="noopener nofollow noreferrer"
                                           dangerouslySetInnerHTML={{__html: intl.formatMessage({id: props.breadcrumbs.parent})}}
                                        />
                                    </li>
                ...
                }
                {
                    props.labelTitle
                        ...
                        <div>
                            <p className='h-sup'
                               dangerouslySetInnerHTML={checkIfValueExistInIntl(props.labelTitle, props)}
                            />
                        </div>
                        :
                        null
...

                    {
                        props.subtitle
                            ...
                            <p className='subtitle'
                               dangerouslySetInnerHTML={{__html: intl.formatMessage({id: props.subtitle})}}
                            >
                            </p>
                            :
                            null
                    }
                    {
                        props.subtitleLg
                            ...
                            <p className='paragraph-1'
                               dangerouslySetInnerHTML={checkIfValueExistInIntl(props.subtitleLg, props)}
                            />
                            :
                            null
                    }
