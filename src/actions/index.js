import {
    ...
    FETCH_TEAM,
    FETCH_EXHIBITIONS,
    FETCH_ROUTES, FETCH_SERVICES, FETCH_COLLECTIONS_MAIN, FETCH_COLLECTIONS_VIRTUAL, FETCH_COLLECTIONS_BYTYPE
} from './types';
...
export const fetchNews = () => async dispatch => {
    const response = await streams.get('/posts?_fields=id,modified_gmt,slug,title,content,excerpt,event_date,event_place,_links,_embedded&_embed');
